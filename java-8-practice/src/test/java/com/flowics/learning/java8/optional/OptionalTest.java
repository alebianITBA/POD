 ...
 */
package com.flowics.learning.java8.optional;
...
public class OptionalTest {
    ...
    public final void new_school_conditional() {
        ...
        nonEmpty.ifPresent(p -> assertEquals(person, nonEmpty.get()));// get the value
    }
    ...
    public final void get_throws_on_empty() {
        assertFalse(emptyOptional.isPresent()); // what should the test expect?
    }
